...
// @Autowired 
// autowired the repository，Spring 4.3+ 后，只有一个构造函数时，没有 @Autowired 也可以
public OrderProcessor(OrderValidator validator, OrderCalculator calculator,
                        OrderRepository repository, NotificationService notifier, PaymentService payments) {
...
// @Repository <-- this annotation can be removed
...
public class PaymentService {
    public void processPayment(Order order) {
        System.out.println(order + "has paid");
    }
}